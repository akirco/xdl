...
function printHelp(): void {
	...
	const lines: string[] = [
		...
		ex(
			"$ xvd https://x.com/user/status/123 --subtitle es",
			"burn Spanish subtitles",
		),
		ex(
			"$ xvd https://x.com/user/status/123 --subtitle tr --gif",
			"subtitles + GIF",
		),
		...
		ex("$ xvd --profile @NASA --video", "videos only"),
		ex("$ xvd --profile @NASA --img", "images only"),
		ex("$ xvd --profile @NASA --retweets", "retweets only"),
		ex("$ xvd --profile @NASA --all", "all tweets + retweets"),
		ex("$ xvd --history"),
		blank,
	];
